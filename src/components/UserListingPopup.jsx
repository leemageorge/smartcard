...
const UserListingPopup = ({onClose,selectedUser,setShowManage }) => {
  ...
  return (
    <div className='fixed top-1/2 left-1/2 -translate-x-1/2 flex items-center gap-4 w-full mx-auto max-w-[350px] h-[30vh] bg-black/50 p-5 rounded-lg shadow-[0_3px_10px_rgba(0,0,0,0.2)] flex flex-col justify-center '>
